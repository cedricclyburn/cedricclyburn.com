...
import logoNcino from '@/images/logos/ncino.svg'
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/file/d/161zDRW20ka8ond946g-O6jA7Ftpk-E9Y/view?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Developer advocate & engineer for all things cloud-native.
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink
              href="https://www.instagram.com/cedricclyburn"
