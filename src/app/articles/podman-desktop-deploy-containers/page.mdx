...
import developerSandboxVerifyDeployment from './developer-sandbox-verify-deployment.png';
...
export const article = {
  ...
  date: '2023-06-09',
  tags: ['containers', 'linux', 'kubernetes', 'openshift'],
  draft: false,
  summary: "Deploy and test a containerized application from your desktop to the no-cost Developer Sandbox for Red Hat OpenShift using Podman Desktop's Developer Sandbox extension.",
  authors: ['default'],
};
