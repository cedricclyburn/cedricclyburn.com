...
import bootableContainersDashboard from './bootable-containers-dashboard.png'
import bootableContainersWorkflow from './bootable-containers-workflow.png'
import podmanDesktopWebsite from './podman-desktop-website.png'
import bootcExtensionCatalog from './bootc-extension-catalog.png'
import bootcExtensionSidebar from './bootc-extension-sidebar.png'
import bootcExamplesPull from './bootc-examples-pull.png'
import bootcImageActions from './bootc-image-actions.png'
import bootcExamplesBuild from './bootc-examples-build.png'
import bootcBuildConfig from './bootc-build-config.png'
import bootcBuildSuccess from './bootc-build-success.png'
import bootcDiskImageDetails from './bootc-disk-image-details.png'
...
<Image src={bootableContainersDashboard} alt="The Bootable Containers dashboard in Podman Desktop" />

## What are bootable containers?

Bootable containers, also provided as [image mode for Red Hat Enterprise Linux](https://developers.redhat.com/products/rhel-image-mode/overview?intcmp=7015Y000003ss1hQAA), represent an innovation in merging containerization technology with full operating system deployment. At their core, bootable containers are OCI ([Open Container Initiative](https://opencontainers.org/)) container images that contain a complete Linux system, including the kernel and hardware support. This approach has several characteristics, namely:
...
<Image src={bootableContainersWorkflow} alt="The process of building and updating existing systems with bootable containers" />
...
<Image src={podmanDesktopWebsite} alt="Download and install Podman Desktop from the official website" />
...
<Image src={bootcExtensionCatalog} alt="Install the Bootable Containers extension for Podman Desktop" />
...
<Image src={bootcExtensionSidebar} alt="The Bootable Containers extension in the Podman Desktop sidebar" />
...
Let's start by preparing the base image, as while application container base images are trimmed to exclude the OS kernel and hardware support, bootable container base images contain the full kernel and hardware support but in a minimal image file size. There are [several flavors of continuously updated base images](https://docs.fedoraproject.org/en-US/bootc/base-images/), but for our workload, we'll use the CentOS bootc image, `quay.io/centos-bootc/centos-bootc:stream9`.
...
<Image src={bootcExamplesPull} alt="Pulling a pre-built bootable container image from the Quay.io registry" />
...
<Image src={bootcImageActions} alt="Multiple options for working with the bootable container image in Podman Desktop" />
...
<Image src={bootcExamplesBuild} alt="Building a disk image using the Podman Desktop bootable containers extension" />
...
<Image src={bootcBuildConfig} alt="Configuring parameters and disk image type to build from the bootable container image" />
...
<Image src={bootcBuildSuccess} alt="Successfully building a bootable container disk image from Podman Desktop" />
...
<Image src={bootcDiskImageDetails} alt="Detailed view of the bootable container disk image" />
