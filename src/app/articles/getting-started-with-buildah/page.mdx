...
export const article = {
  ...
  draft: false,
  summary: 'Use Buildah to create a working Open Container Initiative container image from scratch, or from a pre-existing Dockerfile, before running it with Podman.',
  authors: ['default'],
};
