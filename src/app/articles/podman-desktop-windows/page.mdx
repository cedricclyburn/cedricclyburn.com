...
import podmanDesktopRunNginx from './podman-desktop-run-nginx.png';
import podmanDesktopNginxLogs from './podman-desktop-nginx-logs.png';
import podmanDesktopNginxTerminal from './podman-desktop-nginx-terminal.png';

export const article = {
  title: 'Getting started with Podman Desktop on Windows',
  date: '2023-06-12',
  tags: ['containers', 'linux', 'windows'],
  draft: false,
  summary: 'Learn how to install, setup, and use Podman Desktop on Windows, allowing you to manage and run containers on your Windows machine.',
  authors: ['default'],
};
